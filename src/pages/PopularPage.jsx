...
async function getMovies(pageNo) {
  const res = await axios.get(
    ...
    `https://api.themoviedb.org/3/movie/popular?api_key=${process.env.REACT_APP_API_KEY}&page=${pageNo}&include_adult=false`
  );
    ...
    return (
      <div>
          ...
          <div className='container mx-auto text-black'>
              <h1 className="text-center text-white font-sans text-3xl my-12 font-medium"><span className="font-bold text-amber-300">Popular </span>Movies</h1>
